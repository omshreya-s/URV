...
# load EDA data
ea_file = r"Relaxed(EYES CLOSED)_normal sitting (1)\JULY10 (1)\Day1_July10 _emotibit (1)\2025-07-10_14-37-42-966335_EA (1).csv"
sa_file = r"Relaxed(EYES CLOSED)_normal sitting (1)\JULY10 (1)\Day1_July10 _emotibit (1)\2025-07-10_14-37-42-966335_SA (1).csv"
sf_file = r"Relaxed(EYES CLOSED)_normal sitting (1)\JULY10 (1)\Day1_July10 _emotibit (1)\2025-07-10_14-37-42-966335_SF (1).csv"
sr_file = r"Relaxed(EYES CLOSED)_normal sitting (1)\JULY10 (1)\Day1_July10 _emotibit (1)\2025-07-10_14-37-42-966335_SR (1).csv"
...
min_sf = df_sf['LocalTimestamp'].min() 
max_sf = df_sf['LocalTimestamp'].max() 
